    ...
    questions: [
      {
        ...
        a: 'We are located at 123 Sukhumvit Road, Soi 11, Khlong Toei, Bangkok 10110. We\'re on the 2nd floor — look for the red neon sign! We\'re just a 5-minute walk from Nana BTS Station.',
      },
      {
        q: 'What are your opening hours?',
        a: 'Monday to Friday: 11:00 AM – 9:00 PM\nSaturday to Sunday: 10:00 AM – 10:00 PM\nWalk-ins are welcome when available, but appointments are recommended.',
      },
      {
        q: 'How do I book an appointment?',
        a: 'You can book online through our website\'s booking system, call us at +66 2 123 4567, or visit us in person. We recommend booking at least 3-5 days in advance for the best availability.',
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: 'Yes, a 500 THB non-refundable deposit is required to secure your booking. This deposit goes toward your final tattoo price. The remaining balance is due at the end of your session.',
      },
      {
        q: 'What payment methods do you accept?',
        a: 'We accept Cash, PromptPay, and Credit/Debit Cards (Visa, Mastercard). For large pieces, we can also discuss installment plans during your consultation.',
      },
      {
        q: 'Can I get a price quote before booking?',
        a: 'Absolutely! You can get a rough estimate based on size through our booking page. For an accurate quote, we recommend booking a free consultation where our artist will discuss your design and provide a detailed price.',
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        a: 'We have three incredible artists:\n• Aom — Fine Line & Realism: Delicate, precise work with photorealistic detail\n• Kai — Traditional & Neo-Traditional: Bold, vibrant pieces with masterful color work\n• Mink — Watercolor & Illustrative: Flowing, artistic designs that blend like paint on skin',
      },
      {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          <div className="p-6 rounded-2xl border border-white/5 bg-white/[0.02]">
            ...
            <p className="text-gray-500 text-sm">Mon–Fri: 11AM–9PM<br />Sat–Sun: 10AM–10PM</p>
          </div>
          <div className="p-6 rounded-2xl border border-white/5 bg-white/[0.02]">
            <h3 className="text-white font-semibold mb-3 flex items-center gap-2">
            ...
            <p className="text-gray-500 text-sm">
              <span className="flex items-center gap-2"><MapPin className="w-3.5 h-3.5" /> 123 Sukhumvit Rd, Soi 11, BKK</span>
              <span className="flex items-center gap-2 mt-1"><Phone className="w-3.5 h-3.5" /> +66 2 123 4567</span>
              <span className="flex items-center gap-2 mt-1"><Mail className="w-3.5 h-3.5" /> hello@earthgangtattoo.com</span>
            </p>
          </div>
        </motion.div>
