    ...
    <div className="min-h-screen pt-28 pb-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.6 }} className="text-gray-700 text-xs text-center mt-12">
          AI consultations provide general guidance. For detailed designs, we recommend an in-person consultation with our artists.
        </motion.p>
      </div>
    </div>
  )
