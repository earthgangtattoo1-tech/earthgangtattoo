    ...
    <>
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-neon-red text-sm font-semibold uppercase tracking-widest mb-4">
            Our Work
          </motion.p>
          ...
          <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.2 }} className="text-gray-500 mt-5 max-w-2xl mx-auto">
        ...
        <motion.div ref={ref} initial="hidden" animate={isInView ? 'visible' : 'hidden'} className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5">
          {filtered.map((item, i) => (
            <motion.div
              key={item.label}
              custom={i}
        ...
        >
          <div className="p-12 rounded-2xl border border-white/5 bg-white/[0.02] max-w-2xl mx-auto">
            <h3 className="text-2xl font-bold text-white mb-4">Like What You See?</h3>
            <p className="text-gray-500 mb-8">Let our artists create something unique for you. Book a consultation and bring your vision to life.</p>
            <Link
              to="/booking"
