    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div ref={heroRef} className="relative z-10 text-center px-4 max-w-5xl mx-auto">
          ...
          <motion.p
            ...
            className="mt-10 text-lg sm:text-xl text-gray-400 max-w-2xl mx-auto"
          >
      ...
      <Section className="py-40 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="text-center mb-20">
          ...
          <motion.p variants={fadeInUp} custom={2} className="text-gray-500 mt-5 max-w-2xl mx-auto">
          ...
          {artists.map((artist, i) => (
            ...
            >
              ...
              <div className="p-8 -mt-8 relative">
                ...
                <p className="text-neon-red text-sm font-medium mt-2">{artist.specialty}</p>
                <p className="text-gray-500 text-sm mt-4 leading-relaxed">{artist.description}</p>
                <Link
                  to="/booking"
                  className="inline-flex items-center gap-1 text-sm text-gray-400 hover:text-neon-red mt-6 transition-colors group/link"
                >
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, i) => (
              <motion.div
                ...
                className="p-8 rounded-2xl border border-white/5 hover:border-neon-red/20 bg-white/[0.02] hover:bg-white/[0.04] transition-all duration-300 group cursor-pointer"
              >
                <div className="flex items-start justify-between">
                  <span className="text-3xl">{service.icon}</span>
                  <Shield className="w-4 h-4 text-gray-700 group-hover:text-neon-red/50 transition-colors" />
                </div>
                <h3 className="text-white font-semibold text-lg mt-6">{service.name}</h3>
                <p className="text-gray-600 text-sm mt-2">{service.size}</p>
                <p className="text-neon-red font-bold text-xl mt-5">{service.price}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <Section className="py-44 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <motion.div
            variants={fadeInUp}
            className="relative p-16 sm:p-20 rounded-3xl overflow-hidden border border-white/5"
          ...
          >
            ...
            <div className="relative">
              ...
              <motion.p variants={fadeInUp} custom={1} className="text-gray-400 mt-6 max-w-xl mx-auto">
