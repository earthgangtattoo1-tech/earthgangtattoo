...
import { Calendar, CreditCard, Shield, Lock, Check, ChevronRight, ChevronLeft, Clock, User, FileText, AlertCircle, QrCode } from 'lucide-react'
    ...
    <div className="min-h-screen pt-28 pb-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-12">
          ...
          <p className="text-gray-500 text-center mb-8">Secure your spot with a {deposit} THB deposit</p>
            ...
            <motion.div key="s3" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} transition={{ duration: 0.3 }}>
              ...
              <div className="p-4 rounded-xl bg-white/[0.02] border border-white/5 mb-6">
                <div className="grid grid-cols-2 gap-3 text-sm">
                  ...
                  <div><p className="text-gray-500">Deposit</p><p className="text-neon-red font-bold">{deposit} THB</p></div>
                </div>
              </div>
              ...
              <div className="space-y-5">
                ...
                <div>
                  <label className="text-sm text-gray-400 block mb-1.5">Description / Notes</label>
                  <textarea
                    value={booking.notes}
                    onChange={e => setBooking(b => ({ ...b, notes: e.target.value }))}
                    placeholder="Describe your tattoo idea, placement, size, reference images..."
                    rows={4}
              ...
              <div className="flex gap-3 mt-8">
                ...
                <button
                  disabled={!booking.name || !booking.email || !booking.phone || !booking.service}
                  onClick={() => setStep(4)}
                  className="flex-[3] py-3 rounded-xl bg-neon-red text-white font-semibold hover:bg-neon-red-light disabled:opacity-30 disabled:hover:bg-neon-red transition-all flex items-center justify-center gap-2"
                >
            ...
            <motion.div key="s4" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} transition={{ duration: 0.3 }}>
              ...
              <AnimatePresence mode="wait">
                {paymentMethod === 'card' ? (
                  ...
                  <motion.div key="promptpay" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="text-center py-8">
                    ...
                    <p className="text-gray-600 text-xs mt-1">PromptPay: 081-234-5678</p>
                  </motion.div>
                )}
              </AnimatePresence>
              ...
              <div className="flex gap-3 mt-8">
                ...
                <button
                  ...
                  className="flex-[3] py-3 rounded-xl bg-neon-red text-white font-semibold hover:bg-neon-red-light disabled:opacity-30 disabled:hover:bg-neon-red transition-all flex items-center justify-center gap-2"
                >
                  <Lock className="w-4 h-4" /> Pay {deposit} THB & Confirm
                </button>
              </div>
            </motion.div>
          )}
                ...
                >
                  ...
                  <div className="space-y-3 text-sm">
                    ...
                    <div className="border-t border-white/5 pt-3 flex justify-between">
                      ...
                      <span className="text-green-400 font-bold">{deposit} THB ✓</span>
                    </div>
                  </div>
                </motion.div>
