    ...
    <footer className="bg-dark-light border-t border-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
          ...
          {/* Hours */}
          <div>
            <h3 className="text-white font-semibold text-sm uppercase tracking-wider mb-5">Studio Hours</h3>
            <ul className="space-y-4">
              <li className="flex items-center gap-3">
                <Clock className="w-4 h-4 text-neon-red shrink-0" />
                <div className="text-sm">
                  <p className="text-gray-400">{STUDIO.hoursNote}</p>
                  <p className="text-gray-500 mt-0.5">{STUDIO.hours}</p>
                </div>
              </li>
            </ul>
          </div>
        ...
        {/* Bottom row: Contact info spread evenly */}
        <div className="border-t border-white/5 pt-8">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-center sm:text-left">
            <div className="flex items-center justify-center sm:justify-start gap-3">
              <MapPin className="w-4 h-4 text-neon-red shrink-0" />
